...
`dist/network/mainnet/`. Use `--network testnet` and the matching validator
DARs when producing a TestNet artifact.
...
B64=$(base64 -w0 dist/network/mainnet/canton-streams-mainnet-1.4.0-<package-id-prefix>.dar)
